                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GetBuilder<SubmitReviewController>(builder: (submitReviewController){
                            return !submitReviewController.isLoading?CustomButton(
                              ...
                              onPressed: (){
                                ...
                                if(review.isNotEmpty) {
                                  ReviewBody  reviewBody = ReviewBody(bookingID: bookingIDForReview, serviceID: serviceID, rating: controller.selectedRating.toString(),
                                      comment: review);
