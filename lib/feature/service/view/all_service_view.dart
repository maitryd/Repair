...
class _AllServiceViewState extends State<AllServiceView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title:widget.fromPage == 'allServices' ? 'all_service'.tr : widget.fromPage == 'fromRecommendedScreen' ? 'recommended_for_you'.tr : widget.fromPage == 'fromPopularServiceView' ? 'popular_services'.tr : 'available_service'.tr,showCart: true,),
