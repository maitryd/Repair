   ...
   static Future<Uint8List> generateUint8List(
     ...
     var invoice = Invoice(
      ...
      serviceman: Serviceman(
        name: bookingDetailsContent.serviceman != null? bookingDetailsContent.serviceman!.user!.firstName! :'',
    ...
    return ClipRRect(
      ...
      child:  Container(
          ...
          child: Table.fromTextArray(
            ...
            data: data,
            columnWidths: {
              0: (kIsWeb) ? FixedColumnWidth(Get.width / 9) : FixedColumnWidth(Get.width / 4),
            },
            border: null,
