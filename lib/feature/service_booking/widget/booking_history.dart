        ...
        if(bookingDetailsTabController.bookingDetailsContent!.detail != null){
          ...
          return !bookingDetailsTabController.isLoading ? SingleChildScrollView(
            ...
            children: [
              ...
              Container( child: HistoryStatus(
                statusHistories: _statusScheduleList.toSet().toList(),
                fromStatus: false,
                provider: bookingDetailsContent!.provider != null ? bookingDetailsContent!.provider : null,
              )),
        ...
        contentsBuilder: (_, index) => Padding(
          ...
          child:  Column(
            ...
            children: [
              ...
              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL,),
              if(statusHistories![index].bookingStatus != null && statusHistories![index].user!.userType == "provider-admin")
                Padding(
                  padding: const EdgeInsets.only(top: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  child: Text("${provider!.companyName}",style: ubuntuRegular.copyWith(
              ...
              if( statusHistories![index].user!.userType != "provider-admin")
                Padding(
                  padding: const EdgeInsets.only(top: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  child: Text(
                    "${statusHistories!.elementAt(index).user!.firstName!+ " "+statusHistories!.elementAt(index).user!.lastName!}",style: ubuntuRegular.copyWith(
              ...
              Text("${DateConverter.dateMonthYearTimeTwentyFourFormat(DateConverter.isoUtcStringToLocalDate(statusHistories!.elementAt(index).createdAt.toString()))}",textDirection: TextDirection.ltr,
                ...
                Row(
                children: [
                  Text('${'schedule_time'.tr}:  ',style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
